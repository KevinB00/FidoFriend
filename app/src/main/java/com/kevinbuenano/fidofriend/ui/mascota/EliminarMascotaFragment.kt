...
class EliminarMascotaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_eliminar_mascota, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment EliminarMascotaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EliminarMascotaFragment().apply {
